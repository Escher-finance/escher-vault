#!/nix/store/5c8hb299k0acbypqw6j9m4znyd6b97cz-bash-5.2p37/bin/sh
#
...
# result.
eval_gettext () {
  /nix/store/rgr7r1m8wh4fz953nz4mpq3hxgbqddxf-gettext-0.22.5/bin/gettext "$1" | (export PATH `/nix/store/rgr7r1m8wh4fz953nz4mpq3hxgbqddxf-gettext-0.22.5/bin/envsubst --variables "$1"`; /nix/store/rgr7r1m8wh4fz953nz4mpq3hxgbqddxf-gettext-0.22.5/bin/envsubst "$1")
}
...
eval_ngettext () {
  /nix/store/rgr7r1m8wh4fz953nz4mpq3hxgbqddxf-gettext-0.22.5/bin/ngettext "$1" "$2" "$3" | (export PATH `/nix/store/rgr7r1m8wh4fz953nz4mpq3hxgbqddxf-gettext-0.22.5/bin/envsubst --variables "$1 $2"`; /nix/store/rgr7r1m8wh4fz953nz4mpq3hxgbqddxf-gettext-0.22.5/bin/envsubst "$1 $2")
}
